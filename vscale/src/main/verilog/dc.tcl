...
set MAX_INPUT_DELAY 4.8
set MIN_INPUT_DELAY 4.8
set OUTPUT_MAX_DELAY 4.8
set OUTPUT_MIN_DELAY 4.8
...
set_output_delay $OUTPUT_MAX_DELAY -clock [get_clocks $CLOCK_INPUT] [all_outputs]
